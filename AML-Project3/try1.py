...
# test_x1 = train_x[45000:]
# test_y = train_y[45000:]
# train_x = train_x[:45000]
# train_y = train_y[:45000]

x = tf.placeholder(tf.float32, [None, 4096])
W = tf.Variable(tf.zeros([4096, 82]))
b = tf.Variable(tf.zeros([82]))

y = tf.matmul(x, W) + b
y_ = tf.placeholder(tf.float32, [None, 82])
